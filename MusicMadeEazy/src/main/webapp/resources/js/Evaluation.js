...
$("#evaluationDetails").change(function(){
	
	if($("#evaluationDetails").val() == 'Interview not done' ){
		$(".mandatory").hide();
	}else if($("#evaluationDetails").val() == 'No Show'){
	...
	/*if($("#evaluationDetails").val() == 'Interview not done'||'No Show' ){
		$(".mandatory").css("display","none");
	}else{
		$(".mandatory").css("display","inline");
	}*/
...
$("#submitEvalForm").validate({
	rules: {
		
		requirementsAnalysis: {required: function(element){
			return $("#evaluationDetails").val() != 'Interview not done' && $("#evaluationDetails").val() != 'No Show';
			}
		},

		design: {required: function(element){
			
			return $("#evaluationDetails").val() != 'Interview not done'&& $("#evaluationDetails").val() != 'No Show';
			}
		},
		cut: {required: function(element){
			return $("#evaluationDetails").val() != 'Interview not done'&& $("#evaluationDetails").val() != 'No Show';
			}
		},
		testing: {required: function(element){
			return $("#evaluationDetails").val() != 'Interview not done' && $("#evaluationDetails").val() != 'No Show';
			}
		},
		problemSolving: {required: function(element){
			return $("#evaluationDetails").val() != 'Interview not done' && $("#evaluationDetails").val() != 'No Show';
			}
		},
		workComplexity: {required: function(element){
			return $("#evaluationDetails").val() != 'Interview not done' && $("#evaluationDetails").val() != 'No Show';
			}
		},
		sizeOfProjects: {required: function(element){
			return $("#evaluationDetails").val() != 'Interview not done' && $("#evaluationDetails").val() != 'No Show';
			}
		},
		clientInteraction: {required: function(element){
			return $("#evaluationDetails").val() != 'Interview not done' && $("#evaluationDetails").val() != 'No Show';
			}
		},
		communicationSkill: {required: function(element){
			return $("#evaluationDetails").val() != 'Interview not done' && $("#evaluationDetails").val() != 'No Show';
			}
		},
		leadershipAssertiveSkill: {required: function(element){
			return $("#evaluationDetails").val() != 'Interview not done' && $("#evaluationDetails").val() != 'No Show';
			}
		},
		personalityAppearence: {required: function(element){
			return $("#evaluationDetails").val() != 'Interview not done' && $("#evaluationDetails").val() != 'No Show';
			}
		},
		energyEnthusiasm: {required: function(element){
			return $("#evaluationDetails").val() != 'Interview not done' && $("#evaluationDetails").val() != 'No Show';
			}
		},
		evaluationDetails: {required: function(element){
			return $("#evaluationDetails").val() != 'Interview not done' && $("#evaluationDetails").val() != 'No Show';
			}
		},
		recommendedLevel: {required: function(element){
			return $("#evaluationDetails").val() != 'Interview not done' && $("#evaluationDetails").val() != 'No Show' &&  $("#evaluationDetails").val() != 'Rejected'; 
			}
		},	
		reasonForChange:{required: function(element){
			return $("#evaluationDetails").val() != 'Interview not done' && $("#evaluationDetails").val() != 'No Show' &&  $("#evaluationDetails").val() != 'Rejected'; 
			}
		},
		comments:{required: function(element){
			return $("#evaluationDetails").val() != 'Interview not done' && $("#evaluationDetails").val() != 'No Show' &&  $("#evaluationDetails").val() != 'Rejected'; 
			}
		}
	},
	...
	messages: {
		requirementsAnalysis: "Please enter Requirement & Analysis",
		design: "Please enter Design ",		
		cut: "Please enter Cut",
		testing: "Please enter Testing",
		problemSolving: "Please enter Problem Solving ",
		workComplexity: "Please enter Work Complexity",
		sizeOfProjects: "Please enter Size of Projects",
		clientInteraction: "Please enter Client Interaction",
		communicationSkill: "Please enter Communication Skills",		
		leadershipAssertiveSkill: "Please enter Leadership/Assertive Skills",
		personalityAppearence: "Please enter Personality / Appearance ",
		energyEnthusiasm: "Please enter Energy & Enthusiasm",
		evaluationDetails: "Please enter Evaluation Details",
		recommendedLevel: "Please enter Recommended Level",
		reasonForChange: "Please enter Reason for Change",
		comments: "Please enter Overall Comments"
	    }
});
